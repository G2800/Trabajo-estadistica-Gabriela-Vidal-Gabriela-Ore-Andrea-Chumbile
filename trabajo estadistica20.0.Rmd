...
```{r}
plot(modelo, 3)
#En este caso, la línea roja, al no tender a la horizontalidad, parece mostrar que el modelo no es homocedástico. Para mayor claridad, realizamos el Breusch-Pagan test:
```
