...
```{r}
modelo=lm(reg5,data=datatotal)
summary(modelo)
stargazer(reg5,type = "text",intercept.bottom = FALSE)
##verificando el R2 de cada fórmula y la tabla de Anova, el más óptimo es el último (reg5) que contiene todas las variables independientes menos el PBI
```
...
##hay dos países que son valores influyentes que corresponden a la fila 20 y 61. Los países son: Djibouti y Sudan
